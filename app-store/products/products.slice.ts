...
export const getActiveProduct = (state: RootState) =>
  state.products.activeProduct
export const getSearchResults = (state: RootState) =>
  state.products.searchResults
export const getSearchMetaData = (state: RootState) =>
  state.products.searchMetaData

export const getSearchResultsAction =
  (searchString: string, filter: IProductFilter) =>
