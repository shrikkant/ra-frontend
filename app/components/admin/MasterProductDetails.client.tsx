      ...
      {masterProduct?.id && (
        <Section title={masterProduct.name}>
          ...
          <div className="w-96 flex flex-col gap-y-4 m-auto">
            ...
            <div>
              <SelectField choices={addressList} onChange={handleAddressChange} label="Select Address"></SelectField>
            </div>
            <div className="flex justify-end">
              <Button onClick={addNewListing} type="button">Add Product</Button>
            </div>
          </div>
        </Section>
      )}
