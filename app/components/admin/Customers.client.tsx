  ...
  return (
    <>
      <MyPageHeader title={'Customers'}>
        <div>
          <Input onChange={handlePhoneSearch} label="Search by phone" />
        </div>
      </MyPageHeader>

      {signupStats && <SignupSummary signupStats={signupStats} />}
                  ...
                  <div className="flex gap-x-4 xs:w-full sm:w-80">
                    <div className=" xs:w-full">
                      <div className="flex items-center w-full justify-between">
                        <div
                          onClick={() => visitProfile(person.id)}
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="mt-1 truncate text-xs leading-5 text-gray-500"></div>
                          </div>
                        </div>
