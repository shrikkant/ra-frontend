    ...
    <section className="s-news">
      <PageContainer>
        ...
        <div className="mt-5">
          <div>
            <div>
              <h4><b>Rental Agreement</b></h4>
            </div>
            <div>
              THIS EQUIPMENT LEASE AGREEMENT (“Lease”) is made and effective by clicking on the “I agree, submit this order” button, by and between RentAcross.com and current user (“Renter”). By clicking on the “I agree, submit this order” button, Renter agrees to
              be bound by this Equipment Lease Agreement and all the Terms and Conditions therein, whether or not Renter has read them. RentAcross may at its sole discretion modify this Equipment Lease Agreement and all the Terms and Conditions
              therein at any time. By clicking on the “I agree” button, Renter indicates acceptance of the modified Terms and Conditions.
            </div>
            <div className="mt-3">
              <b>1. Disclaimer</b>
            </div>
            ...
            <div>
              The term of this lease shall commence at the latter of the date the Shipper shows the first attempted delivery or the first day of the rental period shown on order receipt. The term of this lease shall expire on the expiration of the term of days shown
              on the order receipt. The Equipment must be returned to the chosen Shipper by the end of business on the last day of the term of the lease.
            </div>
            <div className="mt-3">
              <b>5. Rent</b>
            </div>
            ...
            <div>
              ...
              <div className="ml-3">
                4. If there is a dispute between RentAcross and Lessee as to whether damage occurred in possession of the Shipper, the equipment shall be sent to an external repair facility. The opinion of the repair facility, as to the cause of the damage, shall be
              ...
              <div className="ml-3">
                ...
                <div className="ml-3">
                  ...
                  <li>Sand</li>
                  <li>Any other matter that must be removed from the Equipment before it is placed back in RentAcross inventory</li>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="ml-3">
                ...
                <div className="ml-3">
                  <li>
                    RentAcross shall charge Lessee’s form of payment the amount owed for replacement of the unreturned Equipment.</li>
                  <li>
            ...
            <div className="ml-3">
              2. RentAcross reserves the right to pursue all available civil and criminal remedies against lessee, including but not limited to: recovering possession of the equipment, obtaining from Lessee’s form of payment any amounts owed, hiring outside debt collection
              firms or private investigators, filing of criminal charges, and any civil remedies available. These remedies are not exclusive.
            </div>
            <div className="mt-3">
            ...
            <div className="ml-3">
              ...
              <div className="ml-3">
                ...
                <li>Damage arising from reckless or grossly negligent use of the equipment</li>
                <li>Damage caused by abnormal or abusive use of the equipment</li>
              </div>
            </div>
            <div className="ml-3">
              4. The Lenscap plan does not limit the liability of the Lessee in regards to
              <div className="ml-3">
                <li>Equipment not returned to RentAcross due to theft, loss, or any other casualty;</li>
            ...
            <div>
              This represents the entire agreement between RentAcross and Lessee. If any portion of this agreement is found unenforceable, it will not affect the remainder of the agreement, which shall remain valid and enforceable. The agreement shall be enforced according
              to the laws.
            </div>
          </div>
        </div>
