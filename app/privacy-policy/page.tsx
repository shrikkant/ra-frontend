        ...
        <PageContainer>
          ...
          <div className="post-body">
            ...
            <p>
              ...
              your interests. Most cookies are &quot;session cookies,
            ...
            <p>
              ...
              name, phone number) from you when you set up a free account with
              us. While you can browse some sections of our website without
              being a registered member, certain activities (such as placing an
              order) may require registration. We do use your contact
          ...
          <div className="post-body">
            <p>
              ...
              data about our users&apos; activity on our website. We identify
              ...
              help identify you and to gather broad demographic information. We
              will occasionally ask you to complete optional online surveys.
            ...
            <p>
              ...
              web server on a web browser so it can be later read back from that
              ...
              temporary cookies in your computer&apos;s hard drive. The cookies
            ...
            <p>
              RentAcross allows you to sign up and login using your Facebook
              account. If you sign up using Facebook, Facebook will ask your
              permission to share certain information from your Facebook account
              with RentAcross. This includes your first name, last name, email
              address in order for us to verify your identitiy and gender,
              general location, a link to your Facebook profile, profile
              picture, your likes and your list of friends.
            </p>

            <p>
              This information is collected by Facebook and is provided to us
              under the terms of
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.facebook.com/policy.php?ref=pf"
              >
                Facebook&apos;s Privacy Policy
              </a>
              . You can control the information that we receive from Facebook
              using the privacy settings in your Facebook account.
            </p>
            <p>
              If you sign up to RentAcross using Facebook, your RentAcross
              account will be connected automatically to your Facebook account,
              and the information regarding your activity on RentAcross,
              specifically any new equipments that you list on RentAcross and
              any new equipment rentals you do, will stay with RentAcross.
            </p>

            <p>
              If you signed up using Facebook by mistake, or if you wish to
              cancel your account and delete your Facebook data with us, you can
              email us at support@rentacross.com. We will cancel your account
              within 48 hours of your intimation.
            </p>

            <p>
              <strong>C. Personal Data Deletion</strong>
            </p>
            <p>
              If you wish to cancel your account and delete all the personal
              data associated with it you can write us at
              support@rentacross.com. We will cancel your account and delete all
              your personal data associated with it with in 48 hours of your
              intimation. If there is any sale/ purchase done by yo, the
              transaction data will be retained by us but your personal
          ...
          <div className="post-body">
            <p>
              ...
              identifiable information about you. RentAcross.com is not
          ...
          <div className="post-title">
            <strong>6. Choice/Opt-Out</strong>
          </div>
          <div className="post-body">
            <p>
              ...
              information from all RentAcross.com lists and newsletters, please
              click on unsubscribe in the email you receive.
            </p>
          </div>

          <div className="post-title">
            <strong>7. Advertisements on RentAcross.com</strong>
          </div>
          <div className="post-body">
            <p>
          ...
          <div className="post-title">
            <strong>9. Questions & Grievances</strong>
          </div>
          <div className="post-body">
