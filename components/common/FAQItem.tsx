  ...
  return (
    <div className="border-b border-gray-100/80 last:border-0">
      ...
      >
        ...
        <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-200 ${isOpen ? 'bg-[#f7ca00] text-gray-900 rotate-180' : 'bg-gray-100 text-gray-500'}`}>
          <svg
