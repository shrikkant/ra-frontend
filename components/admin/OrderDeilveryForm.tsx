...
export const OrderDeliveryForm = ({order}: {order: IOrder}) => {
  ...
  return (
    <div>
      ...
      {customer_address && (
        <div>
          <h2 className="font-semibold border-b border-gray-200 py-2 my-2">
            Customer Address:
          </h2>

          <div>{customer_address.address_line_1}</div>
          <div>
            {customer_address.address_line_2}, {customer_address.city},{' '}
          ...
          {items.map((item, index) => {
            ...
            return (
              <div key={index} className="my-2">
                ...
                <div>
                  {store_address.address_line_2} {store_address.city},{' '}
                  {store_address.postal_code}
                </div>
              </div>
            )
          })}
